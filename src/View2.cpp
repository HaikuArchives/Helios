	...
	: BView(BRect(0, 0, 262, 64), "View2", B_FOLLOW_TOP_BOTTOM | B_FOLLOW_LEFT_RIGHT, B_WILL_DRAW)
{
	...
	textcontrol3 = new BTextControl(BRect(4, 5, 259, 24), "tc", _T("New name:"), NULL, NULL,
	...
	button7 = new BButton(BRect(195, 32, 256, 57), "Button", _T("Ok"), new BMessage(OK_MSG),
						  B_FOLLOW_BOTTOM | B_FOLLOW_RIGHT, B_WILL_DRAW);
	button7->MakeDefault(true);
	AddChild(button7);

	button8 = new BButton(BRect(110, 32, 179, 57), "Button", _T("Cancel"), new BMessage(CANCEL_MSG),
						  B_FOLLOW_BOTTOM | B_FOLLOW_RIGHT, B_WILL_DRAW);
	AddChild(button8);
