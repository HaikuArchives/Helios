...
Application1::DoAudioMenu()
{
	...
	while (window1->view1->listview1->cmenu->CountItems()>0)
		window1->view1->listview1->cmenu->RemoveItem((long int)0);
...
Application1::ShowRecentProjects()
{
	...
	window1->Lock();
	while (window1->view1->openrecentSM->CountItems()>0) delete window1->view1->openrecentSM->RemoveItem((long int)0);
