...
ImageConfigView::ImageConfigView(BRect frame) : ConfigView(frame){
	...
	// TEXTCONTROLS
	publisherTC=new BTextControl(BRect(15,8,frame.Width()-15,33),"icv_publisherTC",_T("CD Publisher:"), // "TPUBLISHER"
					"",NULL);
	...
	preparerTC=new BTextControl(BRect(15,38,frame.Width()-15,63),"icv_preparerTC",_T("CD Preparer:"), // "TPREPARER"
					"",NULL);
	...
	applicationTC=new BTextControl(BRect(15,68,frame.Width()-15,93),"icv_applicationTC",_T("CD Application:"), // "TAPPLICATION"
					"",NULL);
	//applicationTC->SetDivider(applicationTC->StringWidth(_T("CD Application:"))+5); // "TAPPLICATION"
	...
	max_width = publisherTC->StringWidth( publisherTC->Label() ) > preparerTC->StringWidth( preparerTC->Label() ) ?
