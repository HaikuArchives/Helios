...
VideoDVDPanel::VideoDVDPanel(BRect frame)
	: BView(frame, "VideoDVDPanel", B_FOLLOW_LEFT | B_FOLLOW_TOP, B_WILL_DRAW)
{
	filesystemPUM = new BPopUpMenu("");
	filesystemMF = new BMenuField(BRect(0, 0, 200, 21), "filesystemMF", _T("Filesystem"),
	...
	volumenameTC =
		new BTextControl(BRect(0, 0, 200, 21), "volumenameTC", _T("Volume name"), // "TVOLUMENAME"
