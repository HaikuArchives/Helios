...
StatusView::StatusView()
	: BView(BRect(0, 0, 276, 60), "StatusView", B_FOLLOW_TOP_BOTTOM | B_FOLLOW_LEFT_RIGHT,
			B_WILL_DRAW | B_NAVIGABLE)
{
	...
	button17 = new BButton(BRect(205, 33, 274, 58), "v5_cancelB", _T("Cancel"),
						   new BMessage(KILL_MSG), B_FOLLOW_TOP | B_FOLLOW_RIGHT, B_WILL_DRAW);
	AddChild(button17);
