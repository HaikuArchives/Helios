...
private:
	...
	BTextControl* pauseTC, *cdtextTC, *frameTC, *startTC, *endTC;
	BButton* addB, *removeB;
	BView* mainV;
	PlayPauseButton* playPPB;
	TransportButton* stopTB, *rewindTB, *forwardTB, *nextframeTB, *prevframeTB;
	AudioOutput* audioAO;
	BMediaFile* audioMF;
	thread_id updaterT;
	int status;
	BStringView* timeSV, *remainingSV, *framesSV;
	...
	BBox* playerBOX, *indexBOX, *splitBOX, *cdtextBOX, *pauseBOX;

	BButton* selectionstartB, *selectionendB, *mergedownB, *mergeupB;
	BSlider* volumeS;
};
