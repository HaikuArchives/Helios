...
private:
	...
	BCheckBox* forcedCB, *simulationCB, *fixatingCB, *burnproofCB, *writerejectedCB,
		*readerejectedCB, *DAOCB, *overburningCB;
	BSlider* speedSL, *fifoSL;
	BStringView* speedSV, *fifoSV;
