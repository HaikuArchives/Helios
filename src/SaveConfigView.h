...
typedef enum { EM_SAVE_PROJECT = 0, EM_ASK_USER, EM_DO_NOTHING } exit_modes;
...
private:
	...
	BCheckBox* streamedCB, *savewhenquitCB, *autoupdateCB, *balloonhelpCB;
	BRadioButton* autosaveRB, *askforsaveRB, *donothingRB;
