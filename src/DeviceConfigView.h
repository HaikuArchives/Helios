...
private:
	...
	BCheckBox* twodrivecopyCB, *writerejectedCB, *readerejectedCB;

	BBox* scanmethodBOX;
	BRadioButton* defaultRB, *secondRB, *emergencyRB;
	BCheckBox* showallCB;

	BMenuField* writerMF, *readerMF;
	BPopUpMenu* writerPUM, *readerPUM;
	const char** devices;
