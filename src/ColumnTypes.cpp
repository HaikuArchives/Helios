...
BStringEditView::~BStringEditView()
{
	fMasterView = NULL;
	fEditFlags = 0;
}
...
float BBitmapStringColumn::Spacing()
{
	return fSpacing;
}
...
void BBitmapStringField::SetBitmapField(BBitmapField* field)
{
	fBitmapField = field;
}

BStringField* BBitmapStringField::StringField()
{
	return fStringField;
}

void BBitmapStringField::SetStringField(BStringField* field)
{
	fStringField = field;
}
