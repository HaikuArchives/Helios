...
_CLASSNAME::_CLASSNAME(BRect frame, const char* title)
	: BWindow(frame, title, B_TITLED_WINDOW,
			  B_NOT_ZOOMABLE | B_NOT_RESIZABLE | B_NOT_MINIMIZABLE | B_ASYNCHRONOUS_CONTROLS,
			  B_CURRENT_WORKSPACE)
{
	...
	loggingCB = new BCheckBox(BRect(15, 15, 285, 35), "loggingCB",
							  _T("Enable logging"), // "CB:Enable Logging"
