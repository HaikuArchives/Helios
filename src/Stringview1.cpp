...
Stringview1::Stringview1(BRect frame,const char *name,uint32 resizeMask,uint32 flags):BView(frame,name,resizeMask,flags) {
...
void 
Stringview1::SetFileTypeText(BNode *unode) {
/*
