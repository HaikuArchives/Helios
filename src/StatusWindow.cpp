...
StatusWindow::StatusWindow() :
		BWindow(BRect(100, 100, 376, 160), _T("Helios"), // "TSTATUSWINDOWTITLE"
 		B_UNTYPED_WINDOW,
 		B_NOT_CLOSABLE | B_NOT_ZOOMABLE | B_NOT_MINIMIZABLE | B_NOT_H_RESIZABLE | B_NOT_V_RESIZABLE | B_NOT_ANCHORED_ON_ACTIVATE | B_ASYNCHRONOUS_CONTROLS,
 		B_CURRENT_WORKSPACE)
{
...
void
StatusWindow::SetBarColor(rgb_color color)
{
