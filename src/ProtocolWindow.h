...
{
public:
	ProtocolView(BRect frame, const char* name, BRect textRect, uint32 resizingMode, uint32 flags,
				 int stream);
	~ProtocolView();
...
private:
	...
	int fStream;
	BMenu* mainM, *logfileM;
	BMenuItem* clearMI, *closeMI, *enablefileloggingMI, *setlognameMI, *logsettingsMI;
	BFile* logfileF;
