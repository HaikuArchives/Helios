...
VersionConfigView::VersionConfigView(BRect frame) : ConfigView(frame)
{
	cdda2wavVC = new VersionControl(BRect(15, 5, frame.Width() - 15, 21), "vcv_cdda2wavVC",
									B_FOLLOW_LEFT_RIGHT | B_FOLLOW_TOP, B_WILL_DRAW);
	AddChild(cdda2wavVC);
	cdrecordVC = new VersionControl(BRect(15, 25, frame.Width() - 15, 41), "vcv_cdrecordVC",
									B_FOLLOW_LEFT_RIGHT | B_FOLLOW_TOP, B_WILL_DRAW);
	AddChild(cdrecordVC);
	heliosVC = new VersionControl(BRect(15, 45, frame.Width() - 15, 61), "vcv_heliosVC",
								  B_FOLLOW_LEFT_RIGHT | B_FOLLOW_TOP, B_WILL_DRAW);
	AddChild(heliosVC);
	mkisofsVC = new VersionControl(BRect(15, 65, frame.Width() - 15, 81), "vcv_mkisofsVC",
								   B_FOLLOW_LEFT_RIGHT | B_FOLLOW_TOP, B_WILL_DRAW);
	AddChild(mkisofsVC);
	readcdVC = new VersionControl(BRect(15, 85, frame.Width() - 15, 101), "vcv_readcdVC",
								  B_FOLLOW_LEFT_RIGHT | B_FOLLOW_TOP, B_WILL_DRAW);
	AddChild(readcdVC);
}
